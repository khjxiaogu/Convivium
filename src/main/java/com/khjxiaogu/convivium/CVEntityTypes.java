...
public class CVEntityTypes {
	public static final DeferredRegister<EntityType<?>> ENTITY_TYPES = DeferredRegister.create(Registries.ENTITY_TYPE,
			CVMain.MODID);
	public static final DeferredHolder<EntityType<?>, EntityType<WolfFountainProjecttile>> WOLF_FOUNTAIN_DROP = ENTITY_TYPES.register("wolf_fountain_drop",
		t->EntityType.Builder.of(WolfFountainProjecttile::new, MobCategory.MISC)
