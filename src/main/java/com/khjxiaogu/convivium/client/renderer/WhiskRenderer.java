...
public class WhiskRenderer extends RotationRenderer<WhiskBlockEntity> {
	...
	@Override
	public DynamicBlockModelReference getMainRotor(BlockState state, WhiskBlockEntity be) {
		if(state.is(CVBlocks.whisk.get()))
			return cog;
		return null;
	}
